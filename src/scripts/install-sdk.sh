...
function install_flutter() {
  ...
  baseurl="https://storage.googleapis.com/flutter_infra_release/releases/$ORB_VAL_FLUTTER_SDK_CHANNEL"
  fullurl="$baseurl/$uname/${version}_$ORB_VAL_FLUTTER_SDK_VERSION-$ORB_VAL_FLUTTER_SDK_CHANNEL.${suffix}"
